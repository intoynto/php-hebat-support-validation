...
use Intoy\HebatSupport\Validation\Rules\{
    Rule,
    Required
};
...
class Validation
{
     ...
     *
     * @param string $attributeKey
     * @return null|\Intoy\HebatSupport\Validation\Attribute
     */
     ...
     * @return \Intoy\HebatSupport\Validation\ErrorBag
     */
     ...
     * @return array
     */
    protected function parseArrayAttribute($attribute)
    {
        $attributeKey = $attribute->getKey();
     ...
     * @param \Intoy\HebatSupport\Validation\Attribute $attribute
     * @param mixed $value
     * @param \Intoy\HebatSupport\Validation\Rules\Rule $ruleValidator
     * @return void
     */
    protected function addError(Attribute $attribute, $value, $ruleValidator)
    {
     ...
     *
     * @param \Intoy\HebatSupport\Validation\Attribute $attribute
     * @param \Intoy\HebatSupport\Validation\Rule $rule
     * @return bool
     */
    protected function ruleIsOptional($attribute, $rule)
    {
     ...
     * @param \Intoy\HebatSupport\Validation\Attribute $attribute
     * @param mixed $value
     * @param \Intoy\HebatSupport\Validation\Rule $validator
     * @return mixed
     */
    protected function resolveMessage($attribute, $value, $validator)
    {
        $primaryAttribute = $attribute->getPrimaryAttribute();
     ...
     * @return void
     */
    protected function setValidData($attribute, $value)
    {
        $key = $attribute->getKey();
     ...
     * @return void
     */
    protected function setInvalidData($attribute, $value)
    {
        $key = $attribute->getKey();
        if ($attribute->isArrayAttribute() || $attribute->isUsingDotNotation()) {
